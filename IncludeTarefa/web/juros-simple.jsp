<%-- 
    ...
    Created on : 13 de nov. de 2022, 00:46:57
    Author     : naira
--%>
...
<%
    ...
    if (hasParameters){
       try {
        ...
        montante = (capital*taxa*meses)/100;
         
    
    } catch (Exception ex){
    
       errorMessage = "Erro ao tentar ler paramero ";
        }
...
<html>
    ...
    <body class="fundo">
         ...
         <h1 class="titulo">Calcular o Juros Simples</h1>
         <div>
